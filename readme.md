...
`JS-DOM-Replace` by Murad Kasim is an improved version of `findAndReplaceDOMText` (created originally James Padosley).


`JS-DOM-Replace` searches the DOM for words and replaces them without affecting HTML tags, JavaScript or inline CSS. This is very useful if you have to modify the DOM text, since if you use regular find/replace it will affect tags and scripts too. With this project you are also able to add ids, titles and inline CSS styles to every replacement element.
...
findAndReplaceDOMText(document.body, {
    ...
    replace: 'frankfurt',
    wrap: 'mark',
    wrapClass: 'container-replaced-word',
    id: 'unique-element-id-amsterdam',
    title: 'When you hover with the mouse over the replaced text you will read this',
...
### Changelog
 * 1.0.1 (04 Dec 2019): Add options to add ID, Title and Inline CSS to every replaced element (Murad Kasim).
